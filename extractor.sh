...
romzip="$(realpath $1)"
romzipext="${romzip##*.}"
PARTITIONS="abl aop bluetooth cmnlib cmnlib64 devcfg dsp featenabler hyp imagefv keymaster modem qupfw tz uefisecapp xbl_config xbl system vendor cust odm oem factory product xrom modem dtbo boot recovery tz systemex oppo_product preload_common system_ext system_other opproduct reserve india my_preload my_odm my_stock my_operator my_country my_product my_company my_engineering my_heytap"
